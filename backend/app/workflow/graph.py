...
def analysis_node(state: GraphState) -> dict:
    ...
    try:
        ...
        prompt = (
            ...
            f"Format each text section in clean Markdown: use short paragraphs, "
            f"**bold** for key terms (names, numbers, dates), and bullet lists "
            f"('- ' items) when listing multiple points. Keep it skimmable. "
